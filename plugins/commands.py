...
async def start(client, message):
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('✪ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/Tamil_Movie_Request_7"),
            InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url='https://t.me/+7PKyXYgLC9szZjdl')
        ],[
    ...
    if len(message.command) != 2:
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        m=await message.reply_sticker("CAACAgUAAxkBAAICBmcXkt_dTJZMNDrwH7zCorzkc605AAICEQACVb4YVkfLNnccdt9FHgQ") 
            ...
            try:
                ...
                if STREAM_MODE == True:
                    button = [[
                        ...
                        InlineKeyboardButton('𝗕𝗢𝗧 𝗢𝗪𝗡𝗘𝗥', url="https://t.me/TonyStark_xSpidy")
                    ],[
                    ...
                    button = [[
                        ...
                        InlineKeyboardButton('𝗕𝗢𝗧 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥', url="https://t.me/TonyStark_xSpidy")
                    ]]
        ...
        for file in files:
            ...
            if STREAM_MODE == True:
                button = [[
                    ...
                    InlineKeyboardButton("𝗕𝗢𝗧 𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥", url="t.me/TonyStark_xSpidy")
                ],[
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Grp, Set your Shortener\n\nSend this command in your group\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink gplinks.com fbf4cd2983ccd972688409df710237eb1d7ff524\n\nThat's it!!! Enjoy Earning Money 💲\n\n[[[ Trusted Earning Site - https://gplinks.com/.in]]]\n\nIf you have any Doubts, Feel Free to Ask me - @TonyStark_xSpidy\n\n(Puriyala na intha contact la message pannunga - @TonyStark_xSpidy)</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
